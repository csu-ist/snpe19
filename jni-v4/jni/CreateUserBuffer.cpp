                      ...
                      const char * name)
{
   ...
   for (size_t i = bufferShape.rank() - 1; i > 0; i--)
   {
      ...
      std::cerr<< "bufferShape at"<< i <<": "<<bufferShape[i]<<std::endl;
      strides[i-1] = stride;
   }
   ...
   for (size_t i=0; i<strides.size(); i++)
       std::cerr<< "strides at"<< i <<": "<<strides[i]<<std::endl;
   std::cerr<< "bufferElementSize: "<<bufferElementSize<<std::endl;
