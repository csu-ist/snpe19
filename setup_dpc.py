...
INCEPTION_V3_PB_FILENAME            = '0.01_L2tv_mask3.pb'
INCEPTION_V3_PB_OPT_FILENAME        = '0.01_L2tv_mask3_opt.pb'
INCEPTION_V3_DLC_FILENAME           = '0.01_L2tv_mask3.dlc'
INCEPTION_V3_DLC_QUANTIZED_FILENAME = '0.01_L2tv_mask3_quantized.dlc'
...
def prepare_data_images(snpe_root, model_dir, tensorflow_dir):
    ...
    create_raws_script = os.path.join(scripts_dir, 'create_dpc_raws_2.py')
...
def convert_to_dlc(pb_filename, model_dir, tensorflow_dir):
    ...
    cmd = ['snpe-tensorflow-to-dlc',
           ...
           '--input_dim', 'inputdata', '1,50,50,1',
           '--out_node', 'conv_5/BiasAdd',
...
def setup_assets(inception_v3_data_dir, download):
    ...
    model_dir = os.path.join(snpe_root, 'models', 'dpc')
