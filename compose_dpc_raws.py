...
def __get_img_raw(img_filepath, out_y_path):
    ...
    scipy.misc.imsave(out_y_path.split('.')[0]+'-out_100x100_5_dpc.bmp', img_ndarray)
    print(out_y_path.split('.')[0]+'-out_100x100_5_dpc.bmp')
    return img_ndarray
...
__get_img_raw("/opt/SNPE/snpe-1.19.2/models/dpc/data/5_100x100.jpg", "/opt/SNPE/snpe-1.19.2/examples/NativeCpp/SampleCode/output1221-v0-dpc-100x100/Result_6/conv_5/BiasAdd:0.raw")
